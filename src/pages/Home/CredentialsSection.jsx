    ...
    <section className="section bg-light-blue">
      <div className="page-shell">
        <AnimatedSection variant="fadeUp">
          <div className="section-heading mb-16 text-center max-w-3xl mx-auto">
        ...
        <div className="max-w-3xl mx-auto">
          <AnimatedSection variant="fadeUp" delay={0.2} className="w-full flex">
            <article className="group w-full relative p-8 md:p-10 rounded-[20px] bg-pure-white border border-neutral-grey shadow-[0_20px_60px_rgba(0,0,0,0.05)] overflow-hidden transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_30px_70px_rgba(26,72,100,0.08)] flex flex-col justify-between">
              <div>
